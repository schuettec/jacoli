...
class ReflectionUtil {
  ...
  static Collector getCollector(Collection collection) {
    if (collection instanceof Set) {
      ...
      throw ComparisonException.unsupportedCollection(collection);
    }
  }
  ...
  static <D> D newInstance(Class<D> type) {
    try {
      ...
      throw ComparisonException.noDefaultConstructor(type, e);
    } catch (Exception e) {
      throw ComparisonException.newInstanceFailed(type, e);
    }
  }
